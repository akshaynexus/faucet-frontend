...
class SettingsPage extends Component {
  handleSliderChange = (event, value) => {
    ...
    this.props.setSettings({
      ...this.props.settings,
      typography: { ...this.props.settings.typography, fontSize: value },
    });
    // local-storage
  ...
  handleDarkModeToggle = () => {
    ...
    if (this.props.settings.palette.type === "dark")
      this.props.setSettings({
        ...this.props.settings,
        palette: { ...this.props.settings.palette, type: "light" },
      });
    else
      this.props.setSettings({
        ...this.props.settings,
        palette: { ...this.props.settings.palette, type: "dark" },
      });
    // local-storage
    let settings = getLocalSettings();
    if (settings !== null && settings !== undefined) {
      if (settings.palette.type === "dark") settings.palette.type = "light";
  ...
  handleClick = (m, d, l, ms, ls, ds) => {
    ...
    this.props.setSettings({
      ...this.props.settings,
      palette: {
        ...this.props.settings.palette,
        primary: {
          ...this.props.settings.palette.primary,
          main: m,
          dark: d,
          light: l,
        },
        secondary: {
          ...this.props.settings.palette.secondary,
          main: ms,
          dark: ds,
          light: ls,
        },
                  ...
                  {[
                    ...
                    return (
                      <Chip
                        key={i}
                        avatar={
                          <Avatar style={{ backgroundColor: data.main }} />
                        }
                        label={data.name}
                        onClick={() =>
                          this.handleClick(
